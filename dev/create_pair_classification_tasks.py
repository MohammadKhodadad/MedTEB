...
if os.path.exists(output_file):
    ...
    wiki_create_pair_classification_data(["Diseases and disorders by system"],16384,max_depth=2,output_file=output_file)
...
for t1,t2 in tasks:
    ...
    if os.path.exists(output_file):
        ...
        mimic_create_pair_classification_dataset('./dataloaders/data/discharge_processed_v_3.csv',t1,t2,output_file,16384)
...
if os.path.exists(output_file):
    ...
    pubmed_create_pair_classification_data(tasks,16384,output_file)
...
for col2 in cols2:
    ...
    if os.path.exists(output_file):
        ...
        clinical_trials_pair_classification_dataset(col1=col1,col2=col2,page_size=1000,max_pages=17,output_file=output_file)
